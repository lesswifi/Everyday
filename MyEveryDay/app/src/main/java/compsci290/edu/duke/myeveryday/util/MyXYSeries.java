...
public class MyXYSeries implements EditableXYSeries, OrderedXYSeries, PlotListener {
    ...
    private static final String TAG = com.androidplot.xy.SimpleXYSeries.class.getName();
    ...
    public MyXYSeries(ArrayList<JournalEntry> model, com.androidplot.xy.SimpleXYSeries.ArrayFormat format, String title) {
        this(title);
    ...
    public MyXYSeries(List<? extends Number> xVals, List<? extends Number> yVals, String title) {
        this(title);
     ...
     *               For this format x values are autogenerated using values of 0 through n-1 where n is the size of the model.
     */
    public void setModel(List<? extends Number> model, com.androidplot.xy.SimpleXYSeries.ArrayFormat format) {
